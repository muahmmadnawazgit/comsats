...
<div class="container-fluid ">
    <div class="row">
        <div class="col-md-12 d-flex justify-content-center mt-5">
            <a type="button" class="btn btn-danger buttons" href="controllers/add-customer.php">Add-Customer</a>
             <a type="button" class="btn btn-danger buttons ms-3" href="display/displaycustomer.php">Display-Customer</a>
              <a type="button" class="btn btn-danger buttons ms-3" href="order.php">Order</a>
        </div>
    </div>
</div>
