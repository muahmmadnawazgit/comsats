...
<div class="container-fluid ">
    <div class="row">
        <div class="col-md-12 d-flex justify-content-center mt-5">
            <a type="button" class="btn btn-danger buttons" href="controllers/add-employe.php">Add-Employe</a>
             <a type="button" class="btn btn-danger buttons ms-3" href="display/displayemploye.php">Display-Employe</a>
              <a type="button" class="btn btn-danger buttons ms-3" href="display/displaymanager.php">Display-Managers</a>
        </div>
    </div>
</div>
