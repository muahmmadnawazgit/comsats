...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12 d-flex justify-content-center mt-5">
            <a type="button" class="btn btn-danger buttons" href="controllers/add-user.php">Add-User</a>
             <a type="button" class="btn btn-danger buttons ms-3" href="customer.php">Customer</a>
              <a type="button" class="btn btn-danger buttons ms-3" href="employe.php">Employee</a>
        </div>
    </div>
</div>
